...
public class PersonTest {
    ...
    public void equals() {
        ...
        editedAlice = new PersonBuilder(TypicalPersons.ALICE).withRemark("Some remark").build();
        Assertions.assertFalse(TypicalPersons.ALICE.equals(editedAlice));
    }
    ...
    public void toStringMethod() {
        String expected = Person.class.getCanonicalName() + "{name=" + TypicalPersons.ALICE.getName() + ", phone="
                ...
                + ", remark=" + TypicalPersons.ALICE.getRemark() + ", status=" + TypicalPersons.ALICE.getStatus() + "}";
