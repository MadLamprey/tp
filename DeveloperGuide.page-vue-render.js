...
with(this){return _c('p',[_v("Step 1. The user launches the application. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JABPro")]),_v(" will be initialized with the current saved state")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 2. The user wants to add the LinkedIn username to the first person in the list. The user enters the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addL 1 u/alexyeoh")]),_v(" to add the username to the candidate's existing details.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 3. The user can then view the linkedin profile for the candidate at index 1. The user enters the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("linkedin 1")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sat, 28 Oct 2023, 12:23:49 GMT+8]")])])])}
}];
